...
## Visuals
![Alt text](Assets/passwordgeneratordemo.png)

## Installation
Additional programs or extension installation is not needed, the app will run in the browser. Please select the following Github link: 
